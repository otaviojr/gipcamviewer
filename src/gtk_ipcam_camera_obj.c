...
enum
{
  GTK_IPCAM_CAMERA_OBJ_PROP_0,
  GTK_IPCAM_CAMERA_OBJ_PROP_CAMERA_MODEL,
  GTK_IPCAM_CAMERA_OBJ_PROP_CAMERA_NAME,
  GTK_IPCAM_CAMERA_OBJ_PROP_REMOTE_HTTPS,
  GTK_IPCAM_CAMERA_OBJ_PROP_REMOTE_URL,
  GTK_IPCAM_CAMERA_OBJ_PROP_LOCAL_HTTPS,
  GTK_IPCAM_CAMERA_OBJ_PROP_LOCAL_URL,
  GTK_IPCAM_CAMERA_OBJ_PROP_REMOTE_PORT,
  GTK_IPCAM_CAMERA_OBJ_PROP_REMOTE_MEDIA_PORT,
  GTK_IPCAM_CAMERA_OBJ_PROP_LOCAL_PORT,
  GTK_IPCAM_CAMERA_OBJ_PROP_LOCAL_MEDIA_PORT,
...
{
  return g_object_new(GTK_TYPE_IPCAM_CAMERA_OBJ, NULL);
}

GtkIpcamCameraDriverObj*
gtk_ipcam_camera_obj_get_camera_driver(GtkIpcamCameraObj* self)
{
  g_return_val_if_fail (GTK_IS_IPCAM_CAMERA_OBJ(self), NULL);
...
gtk_ipcam_camera_obj_deserialize_item(JsonArray * json_array, guint index, JsonNode* element_node, gpointer user_data)
{
    ...
    GObject* camera = json_gobject_deserialize(GTK_TYPE_IPCAM_CAMERA_OBJ,element_node);
...
gtk_ipcam_camera_obj_get_remote_port(GtkIpcamCameraObj * self)
{
  ...
  g_return_val_if_fail (GTK_IS_IPCAM_CAMERA_OBJ(self), 0);
...
{
  return gtk_ipcam_camera_driver_obj_init_driver(camera->camera_driver, camera);
}
...
gboolean
gtk_ipcam_camera_obj_move_up(GtkIpcamCameraObj* camera)
{
  return gtk_ipcam_camera_driver_obj_move_up(camera->camera_driver, camera);
}

gboolean
gtk_ipcam_camera_obj_move_down(GtkIpcamCameraObj* camera)
{
  return gtk_ipcam_camera_driver_obj_move_down(camera->camera_driver, camera);
}

gboolean
gtk_ipcam_camera_obj_move_left(GtkIpcamCameraObj* camera)
{
  return gtk_ipcam_camera_driver_obj_move_left(camera->camera_driver, camera);
}

gboolean
gtk_ipcam_camera_obj_move_right(GtkIpcamCameraObj* camera)
{
  return gtk_ipcam_camera_driver_obj_move_right(camera->camera_driver, camera);
}

gboolean
gtk_ipcam_camera_obj_is_flipped(GtkIpcamCameraObj* camera)
{
  return gtk_ipcam_camera_driver_obj_is_flipped(camera->camera_driver, camera);
}

gboolean
gtk_ipcam_camera_obj_is_mirrored(GtkIpcamCameraObj* camera)
{
