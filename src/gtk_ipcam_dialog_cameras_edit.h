#ifndef __GTK_FOSCAM_DIALOG_CAMERAS_EDIT_H__
#define __GTK_FOSCAM_DIALOG_CAMERAS_EDIT_H__
...
enum {
  ...
  GTK_FOSCAM_COLUMN_CAMERA_DRIVER_LAST
};
...
#endif //__GTK_FOSCAM_DIALOG_CAMERAS_EDIT_H__
